outCXR.h15 <- read.csv("~/Dropbox/Phil Yates/Sim Results/outCXR-h15.csv")

library(tidyverse)
outCXR.h15.summary <- outCXR.h15 %>%
group_by(tseq) %>%
...
outCXR.h15.summary <- outCXR.h15.summary %>%
...
write_csv(outCXR.h15.summary,"/Users/philipayates/Dropbox/Phil Yates/Sim Results/Summaries/outCXR-h15.csv")
