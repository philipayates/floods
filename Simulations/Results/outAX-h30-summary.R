outAX.h15 <- read.csv("~/Dropbox/Phil Yates/Sim Results/outAX-h30.csv")
...
write_csv(outAX.h15.summary,"/Users/philipayates/Dropbox/Phil Yates/Sim Results/Summaries/outAX-h30.csv")
