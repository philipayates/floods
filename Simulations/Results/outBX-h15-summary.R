outBX.h15 <- read.csv("~/Dropbox/Phil Yates/Sim Results/outBX-h15.csv")

library(tidyverse)
outBX.h15.summary <- outBX.h15 %>%
group_by(tseq) %>%
...
outBX.h15.summary <- outBX.h15.summary %>%
...
write_csv(outBX.h15.summary,"/Users/philipayates/Dropbox/Phil Yates/Sim Results/Summaries/outBX-h15.csv")
