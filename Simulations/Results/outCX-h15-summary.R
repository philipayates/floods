outCX.h15 <- read.csv("~/Dropbox/Phil Yates/Sim Results/outCX-h15.csv")

library(tidyverse)
outCX.h15.summary <- outCX.h15 %>%
group_by(tseq) %>%
...
outCX.h15.summary <- outCX.h15.summary %>%
...
write_csv(outCX.h15.summary,"/Users/philipayates/Dropbox/Phil Yates/Sim Results/Summaries/outCX-h15.csv")
