outCX.h30 <- read.csv("~/Dropbox/Phil Yates/Sim Results/outCX-h30.csv")

library(tidyverse)
outCX.h30.summary <- outCX.h30 %>%
group_by(tseq) %>%
...
outCX.h30.summary <- outCX.h30.summary %>%
...
write_csv(outCX.h30.summary,"/Users/philipayates/Dropbox/Phil Yates/Sim Results/Summaries/outCX-h30.csv")
