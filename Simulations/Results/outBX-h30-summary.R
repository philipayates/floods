outBX.h30 <- read.csv("~/Dropbox/Phil Yates/Sim Results/outBX-h30.csv")

library(tidyverse)
outBX.h30.summary <- outBX.h30 %>%
group_by(tseq) %>%
...
outBX.h30.summary <- outBX.h30.summary %>%
...
write_csv(outBX.h30.summary,"/Users/philipayates/Dropbox/Phil Yates/Sim Results/Summaries/outBX-h30.csv")
