outDX.h15 <- read.csv("~/Dropbox/Phil Yates/Sim Results/outDX-h15.csv")

library(tidyverse)
outDX.h15.summary <- outDX.h15 %>%
group_by(tseq) %>%
...
outDX.h15.summary <- outDX.h15.summary %>%
...
write_csv(outDX.h15.summary,"/Users/philipayates/Dropbox/Phil Yates/Sim Results/Summaries/outDX-h15.csv")
