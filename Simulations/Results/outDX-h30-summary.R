outDX.h30 <- read.csv("~/Dropbox/Phil Yates/Sim Results/outDX-h30.csv")

library(tidyverse)
outDX.h30.summary <- outDX.h30 %>%
group_by(tseq) %>%
...
outDX.h30.summary <- outDX.h30.summary %>%
...
write_csv(outDX.h30.summary,"/Users/philipayates/Dropbox/Phil Yates/Sim Results/Summaries/outDX-h30.csv")
