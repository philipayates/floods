outDXR.h15 <- read.csv("~/Dropbox/Phil Yates/Sim Results/outDXR-h15.csv")

library(tidyverse)
outDXR.h15.summary <- outDXR.h15 %>%
group_by(tseq) %>%
...
outDXR.h15.summary <- outDXR.h15.summary %>%
...
write_csv(outDXR.h15.summary,"/Users/philipayates/Dropbox/Phil Yates/Sim Results/Summaries/outDXR-h15.csv")
