...
To perform the robust local likelihood estimation:
  ...
  - The program `RLLgev.R` produces two components:
    - `parm.est` which for each flood year produces parameter estimates for the robust local likelihood model as well as estimateas for the 99<sup>th</sup> percentile, mean, and median
