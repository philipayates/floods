...
#  s4 <- log(k1)*(1-(delta0+1-k1)/delta0)-(delta0+1-k1)/delta0*(score.num/score.den)
  ...
  s11 <- sum(wstar^2*s1*s1)
  s12 <- sum(wstar^2*s1*s2)
  s13 <- sum(wstar^2*s1*s3)
  s14 <- sum(wstar^2*s1*s4)
  s22 <- sum(wstar^2*s2*s2)
  s23 <- sum(wstar^2*s2*s3)
  s24 <- sum(wstar^2*s2*s4)
  s33 <- sum(wstar^2*s3*s3)
  s34 <- sum(wstar^2*s3*s4)
  s44 <- sum(wstar^2*s4*s4)
  ...
  J11 <- -sum(wstar*(delta0+1)*(delta0-k1)/score.den^2)
  J12 <- -sum(wstar*(delta0+1)*(delta0-k1)*(istar-n*t)/score.den^2)
  J13 <- -sum(wstar*(-k1*score.num-exp(gamma0)*(delta0+1-k1))/score.den^2)
  J14 <- -sum(wstar*(score.den*(1-d_k1_d_delta0)-(delta0+1-k1)*score.num)/score.den^2)
  J22 <- -sum(wstar*(delta0+1)*(delta0-k1)*(istar-n*t)^2/score.den^2)
  J23 <- -sum(wstar*(-k1*(istar-n*t)*score.num-exp(gamma0)*(istar-n*t)*(delta0+1-k1))/score.den^2)
  J24 <- -sum(wstar*(score.den*(istar-n*t)*(1-d_k1_d_delta0)-(istar-n*t)*(delta0+1-k1)*score.num)/score.den^2)
  J33 <- -sum(wstar*(-k1*score.num^2-(delta0+1-k1)*score.num*exp(gamma0))/score.den^2)
  J34 <- -sum(wstar*(score.den*score.num*(1-d_k1_d_delta0)-(delta0+1-k1)*score.num^2)/score.den^2)
#  J44 <- -sum(wstar*(d_k1_d_delta0/k1*((k1-1)/delta0)+log(k1)*(delta0*d_k1_d_delta0+1-k1)/delta0^2+(delta0*d_k1_d_delta0+1-k1)/delta0^2*score.num/score.den+((k1-1)/delta0-1)*(-(score.num/score.den)^2)))
  J44 <- -sum(wstar*(d_k1_d_delta0/k1*(1+k1/delta0)*(1-k1)+log(k1)*(delta0*d_k1_d_delta0+1-k1)/delta0^2+(delta0*d_k1_d_delta0+1-k1)/delta0^2*score.num/score.den+((k1-1)/delta0-1)*(-(score.num/score.den)^2)))
